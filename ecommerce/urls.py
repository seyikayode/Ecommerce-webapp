...
urlpatterns = [
    ...
    path('item/add/<slug>/', add_to_cart, name='add-to-cart'),
    path('item/remove/<slug>/', remove_from_cart, name='remove-from-cart'),
    path('item/add/single/<slug>/', add_single_item_to_cart, name='add-single-item-to-cart'),
    path('item/remove/single/<slug>/', remove_single_item_from_cart, name='remove-single-item-from-cart')
]
